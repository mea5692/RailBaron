...
/**
 * A Railroad Barons (Lonely Edition) game. The main entry point into the model
 * for the entire game (when playing this version).
 *
 * @author Matt Agger, mea5692@rit.edu
 * @author Zachary Talis, zft5955@rit.edu
 */
public class LonelyRailroadBaronsImpl implements RailroadBarons {
     ...
     */
    public LonelyRailroadBaronsImpl() {
        ...
        for(int i = 0; i < 4; i++) {
            ...
            if(i == 0) {
                ...
                baron = Baron.GREEN;
                players.add(new ComputerPlayerImpl(baron, this));
            } else if(i == 2) {
                baron = Baron.YELLOW;
                players.add(new ComputerPlayerImpl(baron, this));
            } else {
